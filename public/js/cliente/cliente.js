...
$( 'input[type=radio][name=descicion_familia]' ).change(function() {


    
    var valor  = $('input[type=radio][name=descicion_familia]:checked').val();
    if(valor == 'Si')  
    $("#div_familia_opinion").attr('hidden',false);
    else
    $("#div_familia_opinion").attr('hidden',true);
